...
variable "instance_template" {
  ...
  default     = "https://www.googleapis.com/compute/beta/projects/yougo-k8-hardway-256417/global/instanceTemplates/searchkings-instance-template20210331234106498000000001"
}
